...
namespace grupo3.prototipos.CAI
{
    ...
    {
        new Vuelo { CodigoVuelo = "AAA123456789123", OrigenVuelo="Buenos Aires, Argentina", DestinoVuelo = "Rio de Janeiro, Brasil", FechaSalidaVuelo=new DateTime(2023,11,15,17,00,00), FechaArriboVuelo=new DateTime(2023, 11, 15,22,30,00), TiempoDeVueloVuelo="5:30hs", AerolineaVuelo="Aerolíneas Argentinas", ClaseVuelo='E', TipoDePasajeroVuelo='A',BaseVuelo=2000, ImpuestosVuelo=1000, ComisionVuelo=95.0000f, DisponibilidadVuelo=8, ParadasVuelo= new string[] { "San Pablo", "Rio" } },
